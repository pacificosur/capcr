<%-- 
    Document   : home
    Created on : 11/04/2019, 11:12:24 PM
    Author     : LabTW06
--%>
...
<head>
  ...
  <title>Sección CRUD de alumnos</title>
      ...
      <div class="container navigation">
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#intro">Inicio Alumno</a></li>
            <li><a href="#service">Crear Alumno</a></li>
            <li><a href="#doctor">Actualizar Alumno</a></li>
            <li><a href="#facilities">Eliminar alumno</a></li>
