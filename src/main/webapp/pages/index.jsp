          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                <img src="../resources/img/dummy/img-1.png" class="img-responsive" alt="" />
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="service" class="home-section nopadding paddingtop-60">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <img src="../resources/img/dummy/img-1.jpg" class="img-responsive" alt="" />
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
            ...
            <div id="grid-container" class="cbp-l-grid-team">
              <ul>
                <li class="cbp-item psychiatrist">
                  <a href="../resources/doctors/member1.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="../resources/img/team/1.jpg" alt="" width="100%">
                    </div>
                  ...
                  <a href="../resources/doctors/member1.html" class="cbp-singlePage cbp-l-grid-team-name">Alice Grue</a>
                  <div class="cbp-l-grid-team-position">Psychiatrist</div>
                </li>
                <li class="cbp-item cardiologist">
                  <a href="../resources/doctors/member2.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="../resources/img/team/2.jpg" alt="" width="100%">
                    </div>
                    <div class="cbp-caption-activeWrap">
                      <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                  ...
                  <a href="../resources/doctors/member2.html" class="cbp-singlePage cbp-l-grid-team-name">Joseph Murphy</a>
                  <div class="cbp-l-grid-team-position">Cardiologist</div>
                </li>
                <li class="cbp-item cardiologist">
                  <a href="../resources/doctors/member3.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="../resources/img/team/3.jpg" alt="" width="100%">
                    </div>
                    <div class="cbp-caption-activeWrap">
                      <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                  ...
                  <a href="../resources/doctors/member3.html" class="cbp-singlePage cbp-l-grid-team-name">Alison Davis</a>
                  <div class="cbp-l-grid-team-position">Cardiologist</div>
                </li>
                <li class="cbp-item neurologist">
                  <a href="../resources/doctors/member4.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="../resources/img/team/4.jpg" alt="" width="100%">
                    </div>
                    <div class="cbp-caption-activeWrap">
                      <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                  ...
                  <a href="../resources/doctors/member4.html" class="cbp-singlePage cbp-l-grid-team-name">Adam Taylor</a>
          ...
          <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="wow bounceInUp" data-wow-delay="0.2s">
              <div id="owl-works" class="owl-carousel">
                <div class="item"><a href="../resources/img/photo/1.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="../resources/img/works/1@2x.jpg"><img src="../resources/img/photo/1.jpg" class="img-responsive" alt="img"></a></div>
                <div class="item"><a href="../resources/img/photo/2.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="../resources/img/works/2@2x.jpg"><img src="../resources/img/photo/2.jpg" class="img-responsive " alt="img"></a></div>
                <div class="item"><a href="../resources/img/photo/3.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="../resources/img/works/3@2x.jpg"><img src="../resources/img/photo/3.jpg" class="img-responsive " alt="img"></a></div>
                <div class="item"><a href="../resources/img/photo/4.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="../resources/img/works/4@2x.jpg"><img src="../resources/img/photo/4.jpg" class="img-responsive " alt="img"></a></div>
                <div class="item"><a href="../resources/img/photo/5.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="../resources/img/works/5@2x.jpg"><img src="../resources/img/photo/5.jpg" class="img-responsive " alt="img"></a></div>
                <div class="item"><a href="../resources/img/photo/6.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="../resources/img/works/6@2x.jpg"><img src="../resources/img/photo/6.jpg" class="img-responsive " alt="img"></a></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="person-text rel text-light">
                      <img src="../resources/img/testimonials/1.jpg" alt="" class="person img-circle" />
                      <a title="" href="#">Anna</a>
                  ...
                  <div class="col-md-4 col-sm-6 hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="../resources/img/testimonials/2.jpg" alt="" class="person img-circle" />
                  ...
                  <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="../resources/img/testimonials/3.jpg" alt="" class="person img-circle" />
                ...
                <div class="item">
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="person-text rel text-light">
                      <img src="../resources/img/testimonials/4.jpg" alt="" class="person img-circle" />
                  ...
                  <div class="col-md-4 col-sm-6 hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="../resources/img/testimonials/5.jpg" alt="" class="person img-circle" />
                  ...
                  <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="../resources/img/testimonials/6.jpg" alt="" class="person img-circle" />
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-3">
            <div class="partner">
              <a href="#"><img src="../resources/img/dummy/partner-1.jpg" alt="" /></a>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="partner">
              <a href="#"><img src="../resources/img/dummy/partner-2.jpg" alt="" /></a>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="partner">
              <a href="#"><img src="../resources/img/dummy/partner-3.jpg" alt="" /></a>
            </div>
          </div>
          <div class="col-sm-6 col-md-3">
            <div class="partner">
              <a href="#"><img src="../resources/img/dummy/partner-4.jpg" alt="" /></a>
            </div>
          </div>
        </div>
      </div>
